...
public record TextBaseline
{
    ...
    /// </summary>
    public readonly static TextAlign Top = new()
    {
        Value = "top",
    };
    /// <summary>
    ...
    /// </summary>
    public readonly static TextAlign Hanging = new()
    {
        Value = "hanging",
    };
    /// <summary>
    ...
    /// </summary>
    public readonly static TextAlign Middle = new()
    {
        Value = "middle",
    };
    /// <summary>
    ...
    /// </summary>
    public readonly static TextAlign Alphabet = new()
    {
        Value = "alphabet",
    };
    /// <summary>
    ...
    /// </summary>
    public readonly static TextAlign Ideographic = new()
    {
        Value = "ideographic",
    };
    /// <summary>
    ...
    /// </summary>
    public readonly static TextAlign Bottom = new()
    {
        Value = "bottom",
    };
}
